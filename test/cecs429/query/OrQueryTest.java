...
public class OrQueryTest {
    ...
    public void testGetPostings() throws IOException {
        ...
        String query = "match + \"256.256.256.256\"";    //And Query with Phrase Query.
        String expResult = "Document4Document5";
    ...
    public void testGetPostingsTwo() throws IOException {
        ...
        String query = "json + text";    //And Query with Phrase Query.
    ...
    public void testGetPostingsThree() throws IOException {
        ...
        String query = "single + \"location\"";    //Or Query with Phrase Query.
        String expResult = "Document4Document5";
        String results = mMethod(query);
        assertEquals(expResult.trim(), results.trim());
    }
